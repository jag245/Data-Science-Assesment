#Script to evaluate differences in nucleotide identity between two sets of genomic sequence data (comparing genomic data sets from Barley yellow dwarf virus isolates.) Outputs file only contains indices for nucleotides with 0% identity and sequence gaps between genomic data sets.
...
df.to_excel(excel_writer="Comparative Genomics Sequence Identity Differences.xls", sheet_name="Sequence Identity", index=False)
